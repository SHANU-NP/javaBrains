...
public class SupervisorListener implements TaskListener {
    ...
    public SupervisorListener(WorkFlowAssigneeService workFlowAssigneeService) {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        log.info("DOCUMENT VERIFICATION FLOW : supervisor job has been started for job id : {} customerID : {}",jobId,customerId);
        delegateTask.setVariable(VARIABLE_SUPERVISOR_DECISION,JOB_STATUS_PENDING);
